...
// Master test 30:AE:A4:07:EA:A8

const uint8_t slaveCustomMac[] = {0x30, 0xAE, 0xA4, 0x07, 0xEA, 0xA8}; //Custom mac address for The Master Device 
const uint8_t masterCustomMac[] = {0x30, 0xAE, 0xA4, 0x4C, 0xB9, 0xA0}; //Custom mac address for The Master Device 
// prod const uint8_t slaveCustomMac[] = {0x30, 0xAE, 0xA4, 0x1A, 0xAE, 0x36};  //Custom mac address for The Slave Device
// prod const uint8_t masterCustomMac[] = {0x30, 0xAE, 0xA4, 0x89, 0x92, 0x71}; //Custom mac address for The Master Device 
...
// ikke sett chanel   ESP_ERROR_CHECK(esp_wifi_set_channel(WIFI_CHANNEL, secondChan));
  ESP_ERROR_CHECK(esp_wifi_get_channel(&primaryChan,&secondChan));
